...
def generate_gw_tree_with_spine(max_depth=10):
    """
    Genera árbol de Galton-Watson condicionado a no extinguirse (espina).
    Retorna un grafo dirigido NetworkX.
    """
    G = nx.DiGraph()
    root = 0
...
def draw_tree(G, save_path=None):
    """
    Dibuja el árbol generado, resaltando la espina en rojo.
    """
